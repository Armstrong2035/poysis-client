          ...
          {(!notebooks || notebooks.length === 0) ? (
            ...
            <div className="flex flex-col flex-1 animate-in fade-in duration-700">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* Option 2: Mock Template 1 */}
                <div className="relative rounded-[32px] border border-zinc-200 bg-white p-6 flex flex-col shadow-sm hover:shadow-xl transition-all cursor-pointer h-[280px] hover:-translate-y-1">
                  ...
                  <div className="text-xs font-bold text-blue-600 uppercase tracking-widest mt-4">
                    Use Template →
                  </div>
                </div>
                ...
                <div className="relative rounded-[32px] border border-zinc-200 bg-white p-6 flex flex-col shadow-sm hover:shadow-xl transition-all cursor-pointer h-[280px] hover:-translate-y-1">
                  ...
                  <div className="text-xs font-bold text-purple-600 uppercase tracking-widest mt-4">
                    Use Template →
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col flex-1 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {notebooks.map((nb) => (
                  <Link 
                    key={nb.id} 
                    href={`/notebook?id=${nb.id}`}
                    className="group rounded-[32px] border border-zinc-200 bg-white p-6 flex flex-col shadow-sm hover:shadow-2xl hover:shadow-zinc-200/50 transition-all hover:-translate-y-1"
                  >
