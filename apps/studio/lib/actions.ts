...
// Published notebooks are served by the separate marketplace app (poysis.com,
// apps/marketplace), not studio — so this only needs to stay in sync with
// THAT app's top-level segments, not studio's.
